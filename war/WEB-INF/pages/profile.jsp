...
<script>
	...
	function changePasswordClicked() {
		...
		console.log(email);
		if (password == null || password == "" || !pwdRegex.test(password)) {
...
<body>
	...
	%>
	<div class="heading">
		<b>Feed Status</b> <span id='userEmail1'><%=userEmail%></span> <input
			type="email" value=<%=userEmail%> id="userEmail">
		...
		<div id="updatedPassword" class="modal">
			<div class="modal-content">
				<div class="imgcontainer">
					<h1 align="center"
						style="font-family: cursive; color: #b1c0cc; margin-top: -0.62cm; font-size: 30px">Change
						Password</h1>
					<span
				...
				<table align="center" cellspacing="3" cellpadding="4">
					...
					<tr>
						...
						<td><input type="button" value="Save" class="submit"
							id="save" onclick='changePasswordClicked()'></td>
					</tr>
					<tr>
						<td id="td"></td>
						<td id="td"><span id='updated'>Your password has been
								changed</span></td>
					</tr>
				</table>
	...
	<div>
		<p
			style="text-align: left; font-family: cursive; font-size: 22px; color: #3e74a0; margin-left: 1cm">Hello,
